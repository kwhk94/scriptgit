...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(10, 100, 120, 80))
        self.pushButton_2.setObjectName(_fromUtf8("pushButton_2"))
        self.pushButton_3 = QtGui.QPushButton(self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(270, 100, 120, 80))
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(140, 100, 120, 80))
        ...
        QtCore.QObject.connect(self.pushButton_4, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.slot5_click)
        ...
        QtCore.QObject.connect(self.pushButton_6, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.slot6_click)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_6.setText(_translate("MainWindow", "메일", None))
